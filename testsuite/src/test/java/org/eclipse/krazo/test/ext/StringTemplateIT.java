...
public class StringTemplateIT {

    private static final String WEB_INF_SRC = "src/main/resources/stringtemplate/";
    ...
    public static WebArchive createDeployment() {
        return new WebArchiveBuilder()
            ...
            .addBeansXml()
            .addDependency("org.eclipse.krazo.ext:krazo-stringtemplate")
            .build();
    }
